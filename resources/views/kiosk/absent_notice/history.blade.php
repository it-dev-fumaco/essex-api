...
<div class="col-md-12 slideInLeft">
	<div class="card mt-3">
      	<div class="card-header h3 text-center">
      		<span class="align-middle">Absent Notice History</span>
	  		<div class="pull-left">
	  			<a href="/kiosk/notice">
	  		...
	  		<div class="pull-right">
	  			<a href="#" onclick="loadnoticehistory()" id="refresh">
		...
		<div class="card-body h-100">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-row mb-4">
        				<div class="col">
            				...
            				<select class="browser-default custom-select" id="month_select" onchange="loadnoticehistory()">
        				...
        				<div class="col">
            				...
            				<select class="browser-default custom-select" id="year_select" onchange="loadnoticehistory()">
				...
				<div class="col-md-12">
					<div class="table-responsive" id="notice_history_table">
					</div>
      			</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		loadnoticehistory();
		$('#spinner').hide();
		$(document).on('click', '#notice_pagination a', function(event){
...
<script type="text/javascript">
	function loadnoticehistory(page){
		...
		$.ajax({
			url: "/kiosk/notice/getnotice_table?page="+page,
			data: data,
			beforeSend: function(){
					 $('#spinner').show();
				},
			success: function(data){
				$('#notice_history_table').html(data);
				$('#spinner').hide();
			}
		});
	}
