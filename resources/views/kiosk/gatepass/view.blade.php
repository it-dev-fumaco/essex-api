...
<div class="card mt-3" style="height: 97%;">
	<div class="card-header h3 text-center">
		<span class="align-middle">Gatepass Details</span>
		...
		<div class="card-body">
			...
			<div class="col-md-12">
				<div class="alert alert-success alert-dismissible fade show" role="alert">
					<h4 class="alert-heading">Request sent to Managers!</h4>
						<p class="mb-0">Please see below details of your gatepass request.</p>
			...
			<div class="col-md-12">
				...
				<div id="gatepass_view_table" style="text-align: center;">
				...
				<div class="btn-group-sm text-center" aria-label="Basic example">
					<button type="button" id="cancelbtn" class="btn btn-danger" data-toggle="modal" data-target="#confirmBack">
						<i class="fa fa-ban mr-1"></i>Cancel Gatepass Slip
					</button>
				</div>
  	...
  	<div class="modal-dialog modal-dialog-centered" role="document">
    	...
    	<div class="modal-content">
      		...
      		<div class="modal-body">
        		<h5>Cancel gatepass notice slip?</h5>
      		</div>
...
<script type="text/javascript">
	function loadviewtable(page){
		...
		$.ajax({
			url: "/kiosk/gatepass/load_view_table",
			success: function(data){
				$('#gatepass_view_table').html(data);
	...
	function cancelnotice(){
		$.ajax({
			url: "/kiosk/gatepass/cancel_slip",
			success: function(data){
