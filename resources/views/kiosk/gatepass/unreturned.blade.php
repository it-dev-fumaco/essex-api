...
<div class="col-md-12 slideInLeft">
	<div class="card mt-3" style="height: 97%;">
  		{{-- <div class="card-header h4">Gatepass - Pending Items for Return
  			<a href="#" onclick="loadunreturnedhistory()" id="refresh" style="float: right;" >
        	<img src="{{ asset('storage/refresh.png') }}"  width="25" height="25"/>
        	</a>
  		</div> --}}
  		 <div class="card-header h3 text-center">
        <span class="align-middle">Gatepass - Pending Items for Return</span>
        ...
        <div class="pull-right">
        	<a href="#" onclick="loadunreturnedhistory()" id="refresh">
		...
		<div class="card-body">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-row mb-4">
        				<div class="col">
            				...
            				<select class="browser-default custom-select" id="month_select" onchange="loadunreturnedhistory()">
        				...
        				<div class="col">
            				...
            				<select class="browser-default custom-select" id="year_select" onchange="loadunreturnedhistory()">
				...
				<div class="col-md-12">
					<div class="table-responsive" id="unreturned_history_table">
...
<script type="text/javascript">
	$(document).ready(function(){
		loadunreturnedhistory();
    $('#spinner').hide();
		$(document).on('click', '#unreturned_pagination a', function(event){
		event.preventDefault();
		var page = $(this).attr('href').split('page=')[1];
		loadunreturnedhistory(page);
		});
	});
</script>
<script type="text/javascript">
	function loadunreturnedhistory(page){
		...
		$.ajax({
			url: "/kiosk/gatepass/getUnreturned_gatepass_table?page="+page,
			data:data,
      beforeSend: function(){
           $('#spinner').show();
        },
			success: function(data){
				$('#unreturned_history_table').html(data);
         $('#spinner').hide();
			}
		});
	}
