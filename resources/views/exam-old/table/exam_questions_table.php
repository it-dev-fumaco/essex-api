<table class="table">
   ...
   <tbody class="table-body">
      ...
      <tr>
         ...
         <td>
            <a href="#" data-toggle="modal" data-target="#deleteQuestion{{$question->question_id}}"><i class="fa fa-eye" aria-hidden="true"></i> View</a> |
            <a href="#" data-toggle="modal" data-target="#editQuestion{{$question->question_id}}"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a> |
