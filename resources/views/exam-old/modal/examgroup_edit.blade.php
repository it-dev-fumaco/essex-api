<!-- The Modal -->
<div class="modal fade" id="editExamGroup{{$examgroup->exam_group_id}}">
         ...
         <div class="modal-body">
            <div class="row" style="margin: 7px;">
               ...
               <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="saveExamGroup"><i class="fa fa-check"></i> Create</button>
