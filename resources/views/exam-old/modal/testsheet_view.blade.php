<!-- The Modal -->
<div class="modal fade" id="viewTestSheet{{$exam->exam_id}}">
   <div class="modal-dialog modal-lg" style="width: 50%;">
      <div class="modal-content">
         <!-- Modal Header -->
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Examination Sheet</h4>
         </div>
         <!-- Modal body -->
         <div class="modal-body">
            <div class="row" style="margin: 7px;">
               <div class="col-sm-6">
                  Examination Title: {{$exam->exam_title}}
               </div>

               <div class="col-sm-6">
                  {{Carbon\Carbon::now()->format('l, F d, Y')}}<br>
                  <div class="col-sm-6">
                     <p class="title-2" id="viewDur" name="viewDur"></p>
                  </div>
                  <div class="col-sm-6">
                     
                     <p class="title-2" id="viewSpent" name="viewSpent"></p>
                  </div>
               </div>
               
               {{--
               <form method='post' action="{{route('admin.exam_save')}}">
                  @csrf
               <div class="col-sm-12">
                  <div class="form-group">
                     <label>Exam Group</label>
                     <select class="selectpicker" name="exam_group_id" id="exam_group_id" class="form-control">
