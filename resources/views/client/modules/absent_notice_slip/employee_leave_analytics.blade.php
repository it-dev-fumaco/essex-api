...
<div id="tabs">
   <ul class="nav nav-tabs" style="text-align: center;">
      ...
      <li class="active"><a href="/module/absent_notice_slip/leave_analytics/{{ Carbon\Carbon::parse('first day of this month')->format('Y-m-d') }}/{{ Carbon\Carbon::parse('last day of this month')->format('Y-m-d') }}">Employee Leave Analytics</a></li>
      ...
      <div class="tab-pane in active">
         <div class="row">
            ...
            <div class="inner-box featured">
               <div class="filters">
                  <form action="/leave_analytics_filter" method="GET">
                     @csrf
                     <span>From:</span>
