...
<div id="tabs">
   <ul class="nav nav-tabs" style="text-align: center;">
      ...
      <li class="active"><a href="/module/absent_notice_slip/leave_approvers">Leave Approver(s)</a></li>
   ...
   <div class="tab-content">
      ...
      <div class="inner-box featured">
         <h2 class="title-2">Leave Approver(s)</h2>
         <div class="row">
            <div class="col-md-12">
               @include('client.modules.absent_notice_slip.leave_approvers.add')
               @if(session("message"))
               ...
               @endif
               <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#add-approver-modal" style="float: left; margin-bottom: -55px; z-index: 1;">
                  <i class="fa fa-plus"></i> Approver
               </a>
            </div>
            <div class="col-md-12">
               <table class="table" id="example">
                  ...
                  <tbody class="table-body">
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="#" data-toggle="modal" data-target="#edit-approver-{{ $approver->approver_id }}">
                              <i class="fa fa-pencil icon-edit"></i>
                           </a>
                           <a href="#" data-toggle="modal" data-target="#delete-approver-{{ $approver->approver_id }}">
                              <i class="fa fa-trash icon-delete"></i> 
                           </a>
                        </td>
                     </tr>
                     @include('client.modules.absent_notice_slip.leave_approvers.edit')
                     @include('client.modules.absent_notice_slip.leave_approvers.delete')
                     @empty
                     <tr>
