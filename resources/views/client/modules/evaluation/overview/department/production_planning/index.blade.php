            ...
            <div class="col-md-12">
               <div class="inner-b1ox featured">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <ul class="nav nav-tabs" style="text-align: center;">
                           <li class="active"><a href="/kpi_stats/production_planning/index">Performance Indicator(s)</a></li>
                           <li><a href="/kpi_overview/production_planning/kpi_result">KPI Result</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="row"></div>
