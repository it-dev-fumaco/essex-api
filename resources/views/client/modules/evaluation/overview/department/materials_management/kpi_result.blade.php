         ...
         <div class="row">
            <div class="col-md-12">
               <div class="inn1er-box featured">
                  <h2 class="title-2">Material Management Department</h2>
                  <div class="row">
                     <div class="col-md-12">
                        <ul class="nav nav-tabs" style="text-align: center;">
                           <li><a href="/kpi_stats/material_management/index">Performance Indicator(s)</a></li>
                           <li class="active"><a href="/kpi_overview/material_management/kpi_result">KPI Result</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="row">
