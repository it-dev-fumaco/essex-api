            ...
            <div class="col-md-12">
               <div class="inn1er-box featured">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <ul class="nav nav-tabs" style="text-align: center;">
                           <li><a href="/kpi_stats/hr/index">Performance Indicator(s)</a></li>
                           <li class="active"><a href="/kpi_overview/hr/kpi_result">KPI Result</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="row" id="filters" style="margin-top: -30px;">
                           ...
                           <input type="hidden" class="department filter" value="6">
                           <div class="col-md-2">
