...
<div id="tabs">
   <ul class="nav nav-tabs" style="text-align: center;">
     <li><a href="/kpi_stats/accounting/index">Accounting</a></li>
      ...
      <li class="active"><a href="/kpi_stats/marketing/index">Marketing</a></li>
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="inn1er-box featured">
                  <h2 class="title-2">Marketing Department</h2>
                  <div class="row">
                     <div class="col-md-12">
                        <ul class="nav nav-tabs" style="text-align: center;">
                           <li><a href="/kpi_stats/marketing/index">Performance Indicator(s)</a></li>
                           <li class="active"><a href="/kpi_overview/marketing/kpi_result">KPI Result</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="row" id="filters" style="margin-top: -30px;">
                           ...
                           <input type="hidden" class="department filter" value="13">
                           <div class="col-md-2">
