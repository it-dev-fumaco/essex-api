...
<div id="tabs">
   <ul class="nav nav-tabs" style="text-align: center;">
      ...
      <li class="active"><a href="/kpi_stats/production/index">Production</a></li>
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="inn1er-box featured">
                  <h2 class="title-2">Production Department</h2>
                  <div class="row">
                     <div class="col-md-12">
                        <ul class="nav nav-tabs" style="text-align: center;">
                           <li><a href="/kpi_stats/production/index">Performance Indicator(s)</a></li>
                           <li class="active"><a href="/kpi_overview/production/kpi_result">KPI Result</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="row">
