            ...
            <div class="col-md-12">
               <div class="inn1er-box featured">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <ul class="nav nav-tabs" style="text-align: center;">
                           <li><a href="/kpi_stats/sales/index">Performance Indicator(s)</a></li>
                           <li class="active"><a href="/kpi_overview/sales/kpi_result">KPI Result</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="row" id="filters" style="margin-top: -30px;">
                           ...
                           <input type="hidden" class="department filter" value="2">
                           <div class="col-md-2">
