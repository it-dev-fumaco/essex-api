...
<div id="tabs">
   <ul class="nav nav-tabs" style="text-align: center;">
      ...
      <li class="active"><a href="/client/analytics/hr">Human Resource</a></li>
         ...
         <div class="row">
            ...
            <div class="col-md-4">
               ...
               <div style="margin-top: 3%; width: 100%;">
                  <canvas id="hiring-rate-chart"></canvas>
               </div>
               <div style="padding: 1% 5%;">
                  <canvas id="job-source-chart" height="200"></canvas>
               </div></center>
            </div>
            <div class="col-md-8">
...
<script>
   $(document).ready(function(){
      ...
      function jobsourceChart(){
         $.ajax({
            url: "/module/hr/job_source_chart",
            method: "GET",
            success: function(data) {
               console.log(data);

               var chartdata = {
                  labels: ['Jobstreet','Indeed','Walk-in','Referrals','LinkedIn','Others'],
                  datasets : [{
                     backgroundColor: '#85C1E9',
                     data: [data.jobstreet, data.indeed, data.walkin, data.referrals,data.linkedIn,data.others],
                     label: "No. of Applicant(s)"
                  }]
               };

               var ctx = $("#job-source-chart");

               if (window.jobSourceCtx != undefined) {
                  window.jobSourceCtx.destroy();
               }

               window.jobSourceCtx = new Chart(ctx, {
                  type: 'horizontalBar',
                  data: chartdata,
