<div class="modal fade" id="deleteDexterity2{{$question->question_id}}">
      ...
      <div class="modal-body">
        ...
        @csrf
          ...
          <div class="row" style="margin-top: -3%;">
            <div class="col-sm-12">
              <span style="font-size: 12pt;">Delete Dexterity & Accuracy Measures 2 <b>"{!! $question->questions !!}"</b> ?</span>
            </div>
          </div>
