  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align: center;">
        <a href="#" class="hover-icon" data-id="{{ $q->question_id }}" data-exam-type="Numerical Exam" id="edit-question-btn"><i class="fa fa-pencil" style="font-size: 15pt; color: #27AE60;"></i></a>
        <a href="#" class="hover-icon" data-id="{{ $q->question_id }}" data-exam-type="Numerical Exam" data-question="{{ $q->questions }}" id="delete-question-btn"><i class="fa fa-trash" style="font-size: 15pt; color: #C0392B;"></i></a>
      </td>
    </tr>
    @empty
    <tr>
