   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form action="/tabUpdateApplicant" method="POST">
               @csrf
               ...
               <div class="row" style="margin: 7px;">
                  <div class="col-sm-6" style="margin-top: -30px;">
                     ...
                     <div class="form-group">
                        <label>Address:</label>
                        <textarea style="width: 100%;" name="address" placeholder="Enter Address">{{ $applicant->address }}</textarea>
                     </div>
                  </div>
                  <div class="col-sm-6" style="margin-top: -30px;">
                     <div class="form-group">
                        <label>Civil Status:</label>
                        <select name="civil_status" style="height: 35px;">
                     ...
                     <div class="form-group">
                        ...
                        <select name="position_applied_for1" required style="height: 35px;">
                     ...
                     <div class="form-group">
                        ...
                        <select name="position_applied_for2" required style="height: 35px;">
                          @foreach($designation_list as $row)
                 ...
                 <i>Last modified: <b>{{ $applicant->updated_at }} </b> -{{ $applicant->last_modified_by }} </i>
                 </div>
               </div>
            </div>
