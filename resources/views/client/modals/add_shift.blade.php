               ...
               <div class="col-sm-12" style="margin-top: -20px;">
                  <table style="width: 100%;">
                     <tr>
                        ...
                        <td colspan="2" style="width: 28%;"><input type="text" name="schedule_name" required></td>
                     </tr>
                     <tr>
                        <td style="width: 20%;"><span style="font-style: italic;">Time In*</span></td>
                        <td style="width: 28%;"><input type="time" name="time_in" required></td>
                        <td style="width: 25%;"><span style="font-style: italic;">Breaktime (hrs)*</span></td>
                        <td style="width: 12%;"><input type="number" name="breaktime" style="width: 60px;" required></td>
                     </tr>
                     <tr>
                        <td style="width: 20%;"><span style="font-style: italic;">Time Out*</span></td>
                        <td style="width: 28%;"><input type="time" name="time_out" required></td>
                        <td style="width: 25%;"><span style="font-style: italic;">Grace Period (mins)*</span></td>
                        <td style="width: 12%;"><input type="number" name="grace_period" style="width: 60px;" required></td>
                     </tr>
                  </table>
               </div>
            </div>
