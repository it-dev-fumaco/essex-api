               ...
               <form  id="formAddExaminee" data-parsley-validate>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                       ...
                       <input type="date" name="date_of_exam" id="date_of_exam" placeholder="Enter Exam Date" min="{{date('Y-m-d')}}" value="{{date('Y-m-d')}}" required>
                    </div>
                    <div class="form-group col-md-6">
                       <label>Validity Date</label>
                       <input type="date" name="validity_date" id="validity_date" placeholder="Enter Validity Date" min="{{date('Y-m-d')}}" value="{{date('Y-m-d')}}" required>
                    </div>
