<!-- The Modal -->
<div class="modal fade" id="edit-shift-schedule-modal">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row" style="margin: 7px;">
               <form id="edit-shift-schedule-form">
               @csrf
               ...
               <div class="col-sm-12" style="margin-top: -20px;">
                  <table style="width: 100%;">
                     <tr>
                        ...
                        <td style="vertical-align: middle;">
                           <div id="datepairExample">
                              <input type="text" name="schedule_date" class="date schedule_date" style="width: 170px;" required autocomplete="off">
                           </div></td>
                        <td style="vertical-align: middle;"><span style="font-style: italic;">Schedule*</span></td>
                        <td style="vertical-align: middle;">
                           <select style="width: 170px;" name="shift_schedule" class="shift_schedule" required>
                     ...
                     <tr>
                        ...
                        <td style="vertical-align: middle;">
                           <select style="width: 170px;" name="branch" class="branch" required>
                        ...
                        <td rowspan="2" style="vertical-align: top;"><textarea rows="3" style="resize: none;" name="remarks" class="remarks"></textarea></td>
                     </tr>
                     <tr>
                        <td style="vertical-align: middle;"><span style="font-style: italic;">Department*</span></td>
                        <td style="vertical-align: middle;">
                           <select style="width: 170px;" name="department" class="department" required>
...
<style type="text/css">
   #edit-shift-schedule-modal table td{
        padding: 8px 0 8px 0;
   }
</style>
