            ...
            <div class="inner-box featured">
              ...
              <div class="tabs-section">
                     <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab-monitoring" data-toggle="tab">Monitoring</a></li>
               ...
               <div class="col-sm-12">
                  <table style="width: 100%;">
                     ...
                     <tr>
                        ...
                        <td style="padding: 1%;">
                           <input type="time" name="adjusted_time" required autocomplete="off" autofocus>
                        </td>
                     </tr>
                     <tr>
...
<style type="text/css">
   #add-biometric-adjustment-form input, select{
      height: 35px;
      width: 90%;
   }
</style>
...
$(document).ready(function() {
  ...
  $('#add-biometric-adjustment-form').on('submit', function(event){
   ...
   function loadAdjustmentMonitoring(page){
      ...
      $.ajax({
         url: "/admin/adj_monitoring?page="+page,
         data: data,
         success:function(data){
   ...
   function loadBiometricAdjustments(page){
      $.ajax({
         url: "/admin/getBioAdjustments?page="+page,
         success: function(data){
