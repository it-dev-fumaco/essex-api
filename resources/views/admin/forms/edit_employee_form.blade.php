               ...
               <div class="columns-wrapper">
                  ...
                  <div class="col-md-12">
                     <div class="inner-box featured">
                        <h2 class="title-2">Edit Employee</h2>
                        ...
                        <div class="row">
                           <div class="col-sm-6">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="user_id" placeholder="Enter Access ID" value="{{ $employee->user_id }}" required>
                              </div>
                              <div class="form-group">
                                 <label>Employee Name:</label>
                                 <input type="text" class="form-control" name="employee_name" placeholder="Enter Employee Name" value="{{ $employee->employee_name }}" required>
                              </div>
                              <div class="form-group">
                                 <label>Birthdate:</label>
                                 <input type="date" class="form-control" name="birthdate" placeholder="Enter Birthdate" value="{{ $employee->birthdate }}" required>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <select class="selectpicker" name="department" required>
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <select class="selectpicker" name="employment_status">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="password" class="form-control" name="password" placeholder="Enter Password" value="{{ $employee->password }}" required>
                              </div>
                           </div>
