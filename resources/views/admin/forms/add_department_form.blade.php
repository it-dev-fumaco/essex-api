            ...
            <div class="col-md-12">
               ...
               <div class="col-sm-12 col-md-6 col-md-offset-3">
                     <div class="inner-box featured">
                        <h2 class="title-2">Add Department</h2>
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                              <form method="POST" action="/admin/saveShift">
                                 @csrf
                              <div class="form-group">
                                 <label>Department:</label>
                                 <input type="text" class="form-control" name="user_id" placeholder="Enter Department Name" required>
                              </div>
                           </div>
