<!-- The Modal -->
<div class="modal fade" id="addIdentif">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row" style="margin: 7px;">
               <form method='post' action="{{route('admin.exam_identif_save')}}">
                  @csrf
                  ...
                  <div class="form-group col-md-6">
                     ...
                     @foreach($examtypes as $examtype)
                        @if($examtype->exam_type == 'Identification - Dexterity and Accuracy Measures')
