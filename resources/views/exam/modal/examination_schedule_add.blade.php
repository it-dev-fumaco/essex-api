...
<!-- The Modal -->
<div class="modal fade" id="addExaminationSchedule">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row" style="margin: 7px;">{{--method='post' action="{{route('admin.examinee_save')}}"--}}
                ...
                <div id="errorDiv"></div>
               <form  id="formAddExaminationSchedule" data-parsley-validate>
                  @csrf
                  ...
                  <div class="modal-footer">
                       <button type="submit" class="btn btn-primary" id="saveExaminationSched"><i class="fa fa-check"></i> Submit</button>
                       <button type="button" class="btn btn-danger" id="closeAddExaminationSchedForm" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                  </div>
               </form>
         </div>
         <!-- Modal footer -->
