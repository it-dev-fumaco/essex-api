            ...
            <div class="row" style="margin: 7px;">
               ...
               <input type="text" name="exam_type_id" id="exam_type_id" value="{{$examtype->exam_type_id}}" hidden="true">
                  ...
                  <div class="form-group">
                     ...
                     <textarea type="text" class="form-control ckeditor" name="instruction" id="instruction" placeholder="Enter Instructions" required>{{$examtype->instruction}}</textarea>
                  </div>

                  <div class="form-group">
                     <label>SVG Abstract Pattern</label>
                     <textarea type="text" class="form-control" name="svgg" id="svgg" placeholder="Enter Instructions" readonly>{{$examtype->instruction}}</textarea>
                  </div>
